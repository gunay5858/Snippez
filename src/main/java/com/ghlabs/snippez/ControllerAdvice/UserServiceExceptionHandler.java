...
public class UserServiceExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleConstraintViolationException(HttpMessageNotReadableException e) {
        ApiErrorResponse error = new ApiErrorResponse(new ApiError(HttpStatus.BAD_REQUEST, "Please provide needed user data"));
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
